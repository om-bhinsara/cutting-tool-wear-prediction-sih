    ...
    return (
      <div className="min-vh-100 d-flex align-items-center justify-content-center position-relative px-3" style={{ background: '#f8fafc' }}>
        ...
        <motion.div
          ...
          style={{ maxWidth: '460px', background: '#ffffff', zIndex: 20 }}
        >
    ...
    <div className="min-vh-100 position-relative pb-5">
      ...
      <div className="live-cad-bg">
        ...
        <svg className="gear-rot-cw" viewBox="0 0 100 100" fill="none" stroke="#0284c7" strokeWidth="1.2">
          ...
          <path d="M50 0 L50 10 M50 90 L50 100 M0 50 L10 50 M90 50 L100 50" strokeWidth="2" />
        </svg>
      </div>
      ...
      <header className="sticky-top border-bottom" style={{ background: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(12px)', borderColor: '#cbd5e1', zIndex: 50 }}>
        <div className="container d-flex flex-wrap justify-content-between align-items-center py-2" style={{ maxWidth: '1280px' }}>
          ...
          <div className="d-flex flex-wrap align-items-center gap-2">
            {[
              { id: 'dashboard', label: 'Live Dashboard', icon: 'bi-speedometer2' },
              { id: 'explainable', label: 'Explainable AI & CAM', icon: 'bi-eye-fill' },
              { id: 'progression', label: 'Wear Trajectory (RUL)', icon: 'bi-graph-up-arrow' },
              { id: 'telemetry', label: 'Sensor Quality', icon: 'bi-activity' },
              { id: 'specs', label: 'Machine Specs', icon: 'bi-tools' },
            ].map((tab) => (
              <button
                key={tab.id}
                type="button"
      ...
      <main className="container position-relative py-4" style={{ maxWidth: '1280px', zIndex: 10 }}>
        ...
        {/* Persistent Process Constraint Warning Banner */}
        <div 
          className="mb-4 p-3 rounded-2 d-flex align-items-center gap-3 shadow-sm"
          style={{
        ...
        {currentPage === 'specs' && (
          <div>
            ...
            {/* Deep Learning Architecture Table */}
            <div className="cad-panel p-4">
              <div className="crosshair ch-tl" /><div className="crosshair ch-tr" /><div className="crosshair ch-bl" /><div className="crosshair ch-br" />
